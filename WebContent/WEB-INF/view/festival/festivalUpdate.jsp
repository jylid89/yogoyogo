		...
		$("#foodUpdate").click(function(){
			...
			$("#event_map").val($("#sample4_postcode").val());			
				var result = confirm(' 수정 하시겠습니까?');
					if(result) {
						$("#festivalUpdateForm").attr("action","festivalUpdateOk.do").submit();
					}
		});
...
<body>
    ...
    <div class="col-md-12">
    <br/><br/>
        <h1 class="entry-title"><span>행사 수정</span> </h1>
        <hr>
            <form class="form-horizontal" method="post"  id="festivalUpdateForm" enctype="multipart/form-data">        
        <br/><br/>
        <div class="form-group">
          <label class="control-label col-sm-3">행사명 : <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-9">
              <input type="email" class="form-control" name="event_name" id="event_name" value="${listModel.event_name }">
      		  <input type="hidden" name='event_num' value="${listModel.event_num}">
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-9">
			<input type="text" class="form-control" id="sample4_postcode"  readonly="readonly" value="${listModel.event_map}"/>
          </div>
		 ...
		 <div class="col-md-5 col-sm-9">
				<input type="text" class="form-control" id="sample4_roadAddress"  readonly="readonly" value="${listModel.event_loc }"/>
		 </div>
		 </div>
		 <div class="form-group">
		 	<label class="control-label col-sm-3"></label>
        ...
        <div class="form-group">
          <label class="control-label col-sm-3">행사 시작 날짜 : <span class="text-danger">*</span></label>
          	<div class="col-md-3 col-sm-9">
            	<input type="text" class="form-control" name="event_start" id="event_start" value="${listModel.event_start}">
        	</div>
        </div>
        <div class="form-group">
        	<label class="control-label col-sm-3">행사 종료 날짜 : <span class="textnger">*</span></label>
          		<div class="col-md-3 col-sm-9">
              		<input type="text" class="form-control" name="event_end" id="event_end" value="${listModel.event_end}">
        		</div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">행사 주최 : <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-9">
              <input type="text" class="form-control" name="event_comp" id="event_comp" value="${listModel.event_comp }">
        </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">행사 홍보내용 : <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-9">
              <textarea class="form-control" name="event_content" id="event_content" rows="30" >${listModel.event_content }</textarea> 
        </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group"> <span class="input-group-addon" id="file_upload"><i class="glyphicon glyphicon-upload"></i></span>
              ...
              <input type='hidden' name='exFile' value="${listModel.event_picreal}" />
            </div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-xs-offset-3 col-xs-10">
            ...
            <input name="foodUpdate" type="button" value="수정" class="btn btn-primary" id="foodUpdate">
          </div>
        </div>
      </form>
        </div>
