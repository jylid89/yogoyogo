					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-12 col-sm-12 scrollpoint">
								<form role="form" method="post" action="noticeUpdateOk.do" enctype="multipart/form-data">
									<input type='hidden' name='board_num' value='${noticeList.board_num }'>
									<div class="form-group">
										<label class="col-md-3 control-label" for="name"><h3>제목</h3></label> 
										<input name='board_title' type="text" class="form-control" value="${noticeList.board_title}">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea name='board_content'  cols="30" rows="10" class="form-control"
											value='${noticeList.board_content }'></textarea>
									</div>
									<!-- **************파일첨부 1************* -->
									 <div class="form-group ">
										<label class="col-md-12 control-label" for="message"><h3>사진 업로드</h3></label>
									            <!-- image-preview-filename input [CUT FROM HERE]-->
									            <div class="input-group image-preview">
									                <input  value='${noticeList.board_picreal}'  type="text" class="form-control image-preview-filename" disabled="disabled"> <!-- don't give a name === doesn't send on POST/GET -->
									                <span class="input-group-btn">
									                    ...
									                    <div class="btn image-preview-input btn-primary btn-lg">
									                        ...
									                        <input name="board_pictemp" type="file" accept="image/png, image/jpeg, image/gif" />
									                         <!-- rename it -->
									                    </div>
									                </span>
