...
<link href="/YogoYogo/css/main/font.css" rel="stylesheet">
...
<div class="container">
	<br/><br/>
    <div class="row"><h1 class="text-center"><font face="함초롬돋움" size="6px">${vo.adv_title }</font></h1>
